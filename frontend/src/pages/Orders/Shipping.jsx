    ...
    <div className="container mx-auto pt-5">
      ...
      <div className=" flex justify-around items-center flex-wrap">
        <form className="w-[40rem]">
          <h1 className="text-2xl font-semibold mb-4 text-pink-900">
            Shipping
          </h1>
          <div className="mb-4">
            <label
          ...
          <div className="mb-4">
            <label
              htmlFor="PayPal"
              className="mb-2 flex justify-start items-center text-sm font-medium text-gray-700"
            >
              <input
                type="radio"
                id="PayPal"
                ...
                className="  cursor-pointer  block w-4 h-4 accent-pink-500 p-2 border border-gray-300 
                "
              />
              {/* #003087  #009CDE*/}
              {/* <FaCcPaypal size={30} color="blue" className="ml-2"/> */}
              {/* <LiaPaypal size={30} color="#003087" className="ml-2" /> */}
              {/* <ImPaypal size={30} color="#003087" className="ml-2" /> */}
              <svg
            ...
            >
              ...
              <SiVodafone
                color="#cc2131"
                className="w-5  cursor-pointer  h-5 ml-2"
              />
              <span className="pl-1 italic scale-x-100 cursor-pointer font-bold text-[#cc2131]">
                Vodafone Cash
              </span>
          ...
          <button
            ...
            className="bg-pink-500 cursor-pointer  font-semibold hover:bg-pink-600 text-white py-2 px-4 rounded-md"
          >
            Continue to Payment
          </button>
        </form>
